...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.external_image_link'
        db.add_column(u'octopus_groceries_recipe', 'external_image_link',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Recipe.link'
        db.add_column(u'octopus_groceries_recipe', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.external_image_link'
        db.delete_column(u'octopus_groceries_recipe', 'external_image_link')

        # Deleting field 'Recipe.link'
        db.delete_column(u'octopus_groceries_recipe', 'link')
    ...
    models = {
        ...
        u'octopus_groceries.product': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['octopus_groceries.Department']", 'null': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
