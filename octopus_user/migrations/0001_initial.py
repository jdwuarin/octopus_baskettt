...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'octopus_user_userproductslack', (
            ...
            ('purchase_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 24, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'octopus_user', ['UserProductSlack'])

        # Adding model 'UserInvited'
        db.create_table(u'octopus_user_userinvited', (
            ('email', self.gf('django.db.models.fields.CharField')(max_length=150, primary_key=True)),
            ('is_invited', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
