...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.created_at'
        db.add_column(u'octopus_user_usersettings', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 15, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


        # Changing field 'UserGeneratedBasket.time'
        db.alter_column(u'octopus_user_usergeneratedbasket', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'UserRecommendedBasket.time'
        db.alter_column(u'octopus_user_userrecommendedbasket', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserProductSlack.purchase_time'
        db.alter_column(u'octopus_user_userproductslack', 'purchase_time', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'UserSettings.created_at'
        db.delete_column(u'octopus_user_usersettings', 'created_at')


        # Changing field 'UserGeneratedBasket.time'
        db.alter_column(u'octopus_user_usergeneratedbasket', 'time', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'UserRecommendedBasket.time'
        db.alter_column(u'octopus_user_userrecommendedbasket', 'time', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        u'octopus_user.usergeneratedbasket': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': '0', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'octopus_user.userproductslack': {
            ...
            'purchase_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'octopus_user.userrecommendedbasket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product_dict': ('django_hstore.fields.DictionaryField', [], {'db_index': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'octopus_user.usersettings': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
