...
class Product(models.Model):
    ...
    def __unicode__(self): 
        return str(self.name) + ", " + str(self.price) + ", " + str(self.supermarket) + ", " + str(self.quantity) + ", " + str(self.unit)
...
class Recipe_abstract_product(models.Model):

    recipe               = models.ForeignKey(Recipe, default=-1, editable=False)
    abstract_product   = models.ForeignKey(Abstract_product, default=-1, editable=False)
    ...
    def __unicode__(self):
        return str(self.recipe_id) + ", " + str(self.abstract_product_id) + ", " + str(self.quantity) + ", " + str(self.unit)


class Abstract_product_product(models.Model):
