...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProductSlack.user'
        db.alter_column(u'octopus_user_userproductslack', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['octopus_user.OctopusUser']))

        # Changing field 'UserSettings.user'
        db.alter_column(u'octopus_user_usersettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['octopus_user.OctopusUser'], unique=True, null=True))

        # Changing field 'UserInvited.email'
        db.alter_column(u'octopus_user_userinvited', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254, primary_key=True))

        # Changing field 'UserGeneratedBasket.user'
        db.alter_column(u'octopus_user_usergeneratedbasket', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['octopus_user.OctopusUser']))

        # Changing field 'UserRecommendedBasket.user'
        db.alter_column(u'octopus_user_userrecommendedbasket', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['octopus_user.OctopusUser']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProductSlack.user'
        db.alter_column(u'octopus_user_userproductslack', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserSettings.user'
        db.alter_column(u'octopus_user_usersettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))

        # Changing field 'UserInvited.email'
        db.alter_column(u'octopus_user_userinvited', 'email', self.gf('django.db.models.fields.CharField')(max_length=150, primary_key=True))

        # Changing field 'UserGeneratedBasket.user'
        db.alter_column(u'octopus_user_usergeneratedbasket', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserRecommendedBasket.user'
        db.alter_column(u'octopus_user_userrecommendedbasket', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'octopus_groceries.product': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['octopus_groceries.Department']", 'null': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'octopus_user.userproductslack': {
            ...
            'purchase_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
