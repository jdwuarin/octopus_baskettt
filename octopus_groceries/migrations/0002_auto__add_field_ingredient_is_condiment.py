...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Ingredient.is_condiment'
        db.add_column(u'octopusProducts_ingredient', 'is_condiment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ingredient.is_condiment'
        db.delete_column(u'octopusProducts_ingredient', 'is_condiment')
    ...
    models = {
        ...
        u'octopusProducts.ingredient': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_condiment': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'octopusProducts.ingredient_product': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient': ('django.db.models.fields.related.ForeignKey', [],
                           {'default': '-1', 'to': u"orm['octopusProducts.Ingredient']"}),
            'product_tesco': ('django.db.models.fields.related.ForeignKey', [],
                              {'related_name': "'product_tesco_id'", 'to': u"orm['octopusProducts.Product']"}),
        ...
        u'octopusProducts.recipe_ingredient': {
            ...
            'recipe': ('django.db.models.fields.related.ForeignKey', [],
                       {'default': '-1', 'to': u"orm['octopusProducts.Recipe']"}),
        ...
        u'octopusProducts.tag_recipe': {
            ...
            'recipe': ('django.db.models.fields.related.ForeignKey', [],
                       {'default': '-1', 'to': u"orm['octopusProducts.Recipe']"}),
            'tag': (
            'django.db.models.fields.related.ForeignKey', [], {'default': '-1', 'to': u"orm['octopusProducts.Tag']"})
        },
        u'octopusProducts.user_product_slack': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [],
                        {'default': '-1', 'to': u"orm['octopusProducts.Product']"}),
