...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProductSlack.purchase_time'
        db.alter_column(u'octopus_user_userproductslack', 'purchase_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'UserSettings.recommendation_email_subscription'
        db.add_column(u'octopus_user_usersettings', 'recommendation_email_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserSettings.news_email_subscription'
        db.add_column(u'octopus_user_usersettings', 'news_email_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'UserSettings.created_at'
        db.alter_column(u'octopus_user_usersettings', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Deleting field 'UserGeneratedBasket.time'
        db.delete_column(u'octopus_user_usergeneratedbasket', 'time')

        # Adding field 'UserGeneratedBasket.created_at'
        db.add_column(u'octopus_user_usergeneratedbasket', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 22, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserRecommendedBasket.time'
        db.delete_column(u'octopus_user_userrecommendedbasket', 'time')

        # Adding field 'UserRecommendedBasket.created_at'
        db.add_column(u'octopus_user_userrecommendedbasket', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 22, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProductSlack.purchase_time'
        db.alter_column(u'octopus_user_userproductslack', 'purchase_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'UserSettings.recommendation_email_subscription'
        db.delete_column(u'octopus_user_usersettings', 'recommendation_email_subscription')

        # Deleting field 'UserSettings.news_email_subscription'
        db.delete_column(u'octopus_user_usersettings', 'news_email_subscription')


        # Changing field 'UserSettings.created_at'
        db.alter_column(u'octopus_user_usersettings', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding field 'UserGeneratedBasket.time'
        db.add_column(u'octopus_user_usergeneratedbasket', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=0, auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserGeneratedBasket.created_at'
        db.delete_column(u'octopus_user_usergeneratedbasket', 'created_at')

        # Adding field 'UserRecommendedBasket.time'
        db.add_column(u'octopus_user_userrecommendedbasket', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 15, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserRecommendedBasket.created_at'
        db.delete_column(u'octopus_user_userrecommendedbasket', 'created_at')
    ...
    models = {
        ...
        u'octopus_user.userproductslack': {
            ...
            'purchase_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
