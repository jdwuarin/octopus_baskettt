...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Cart', fields ['name', 'user']
        db.create_unique(u'octopus_basket_cart', ['name', 'user_id'])

        # Adding unique constraint on 'Basket', fields ['name', 'user']
        db.create_unique(u'octopus_basket_basket', ['name', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Basket', fields ['name', 'user']
        db.delete_unique(u'octopus_basket_basket', ['name', 'user_id'])

        # Removing unique constraint on 'Cart', fields ['name', 'user']
        db.delete_unique(u'octopus_basket_cart', ['name', 'user_id'])
    ...
    models = {
        ...
        u'octopus_basket.basket': {
            'Meta': {'unique_together': "(('name', 'user'),)", 'object_name': 'Basket'},
        ...
        u'octopus_basket.cart': {
            'Meta': {'unique_together': "(('name', 'user'),)", 'object_name': 'Cart'},
